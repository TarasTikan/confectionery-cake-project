...
export const FilterModalMob = () => {
  ...
  const { handleToggleFilter, isOpenFilter } = useFilterActions();

  return (
    <>
      <Backdrop open={isOpenFilter} onClick={handleToggleFilter}>
        <MobFilterSection
          open={isOpenFilter}
          onClick={(e) => e.stopPropagation()}
        >
          <MobFilterContainer>
            <BtnHeaderClouse type="button" onClick={handleToggleFilter}>
              x
            </BtnHeaderClouse>
            <WrapFilter>
              <Field>
                ...
                <Select
                  ...
                  value={getTastes}
                >
                  <option defaultValue="За замовчуванням">
                    За замовчуванням
                  </option>
              ...
              <Field>
                <Label>
                  ...
                  <Range
                    ...
                    onChange={(e) =>
                      dispatch(selectedPriceRange(e.target.value))
                    }
                    min="0"
                    max="2000"
              ...
              <ClearFiltrBtn
                type="button"
                onClick={(e) => dispatch(clearFilter())}
              >
                Скинути фільтри
              </ClearFiltrBtn>
            </WrapFilter>
